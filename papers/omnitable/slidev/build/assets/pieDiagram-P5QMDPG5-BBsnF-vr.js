import{o as e}from"./Mermaid-UVzi8SV_.js";import{r as t}from"./chunk-35ZOQMXA-CyDLOecq.js";import{M as n,N as r,T as i,n as a}from"./chunk-OHNBJXQ2-a68LuocA.js";import{$ as o,C as s,E as c,J as l,Y as u,b as d,l as f,m as p,o as m,x as h}from"./chunk-KMA2NSDO-DoHLeCU3.js";import"./chunk-445WJIJ4-4_n40hzO.js";import{h as g,i as _}from"./chunk-TI7YOFXF-CqThJkGd.js";import{t as v}from"./chunk-X67BZSRO-BW30XYDA.js";import{M as y}from"./chunk-YOWFEKIV-BvknFjdJ.js";var b=p.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:t(()=>structuredClone(w),`getConfig`),clear:t(()=>{S=new Map,C=x.showData,m()},`clear`),setDiagramTitle:o,getDiagramTitle:c,setAccTitle:u,getAccTitle:h,setAccDescription:l,getAccDescription:d,addSection:t(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),i.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:t(()=>S,`getSections`),setShowData:t(e=>{C=e},`setShowData`),getShowData:t(()=>C,`getShowData`)},E=t((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:t(async e=>{let t=await y(`pie`,e);i.debug(t),E(t,T)},`parse`)},O=t(e=>`
  .pieCircle{
